...
<head>
    ...
    <title>Quên mật khẩu • Cyber Access</title>
...
<div class="w-full max-w-md cyber-card p-10">
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
        ...
        <div class="text-center mb-6">
            <h2 class="text-xl font-bold mb-2">Quên mật khẩu?</h2>
            <p class="text-white/70 text-sm">
                Không sao! Hãy nhập email của bạn và chúng tôi sẽ gửi link đặt lại mật khẩu.
            </p>
        </div>
